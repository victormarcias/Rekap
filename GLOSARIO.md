...
- **Read replica** — [Escalabilidad de Base de Datos](sql/escalabilidad-db.md#read-replicas)
...
- **Replication lag** — [Escalabilidad de Base de Datos](sql/escalabilidad-db.md#read-replicas)
