...
---
Relacionado: [SOLID principles](solid.es.md), [Controller / Service / Repository](../backend/controller-service-repository.es.md), [Patrones estructurales](structural-patterns.es.md#adapter).
