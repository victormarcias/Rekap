...
---
Relacionado: [Autenticación vs Autorización](../backend/authentication.es.md#7-autenticación-vs-autorización), [Idempotencia](quality-attributes.es.md#idempotencia), [Endpoints para microservicios](../stacks/fastapi/endpoints-microservicios.md).
