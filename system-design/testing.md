...
---
Relacionado: [Testing en FastAPI](../backend/fastapi/testing.md), [ACID / transacciones / isolation levels](../sql/acid-transacciones-isolation.md) (transacciones y rollback), [Idempotencia](atributos-de-calidad.md).
