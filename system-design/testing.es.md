...
Fundamentos de testing que aplican en cualquier lenguaje. La implementación concreta con pytest/FastAPI está en [Testing en FastAPI](../stacks/fastapi/testing.es.md).
...
pytest no tiene estas cuatro funciones como tal — resuelve lo mismo con el parámetro `scope` de una fixture (ver la implementación completa en [Testing en FastAPI](../stacks/fastapi/testing.es.md#9-hooks-de-setupteardown-en-pytest-scope-de-las-fixtures)).
...
Ver la implementación en pytest en [Testing en FastAPI](../stacks/fastapi/testing.es.md#1-pytest-fixtures-y-conftestpy).
...
---
Relacionado: [Testing en FastAPI](../stacks/fastapi/testing.es.md), [ACID / transacciones / isolation levels](../database/acid.es.md) (transacciones y rollback), [Idempotencia](quality-attributes.es.md).
