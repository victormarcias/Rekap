...
---
Relacionado: [Testing en FastAPI](../stacks/fastapi/testing.md), [ACID / transacciones / isolation levels](../database/acid.es.md) (transacciones y rollback), [Idempotencia](quality-attributes.es.md).
