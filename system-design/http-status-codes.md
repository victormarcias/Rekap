...
---
Relacionado: [Autenticación vs Autorización](../backend/autenticacion.md#7-autenticación-vs-autorización), [Idempotencia](atributos-de-calidad.md#idempotencia), [Endpoints para microservicios](../python/endpoints-microservicios.md).
