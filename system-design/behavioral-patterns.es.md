...
Ver el ejemplo completo (con TypeScript) en [Open/Closed Principle](solid.es.md) — Strategy es la implementación concreta de ese principio.
...
---
Relacionado: [SOLID principles](solid.es.md) · catálogo completo en [refactoring.guru](https://refactoring.guru/design-patterns/behavioral-patterns).
