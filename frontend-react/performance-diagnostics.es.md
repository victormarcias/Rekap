...
Auditoría automatizada que corre en cualquier página (Chrome DevTools, CLI, o CI) y devuelve un score de Performance, Accessibility, Best Practices y SEO, con recomendaciones puntuales. Mide los [Core Web Vitals](web-vitals.es.md) (LCP, INP, CLS).
...
---
Relacionado: [Web Vitals](web-vitals.es.md), [Diagnóstico Frontend](../diagnostics/frontend.es.md), [Tree shaking](tree-shaking.es.md).
