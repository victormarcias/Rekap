...
Es exactamente el mecanismo de bajo nivel detrás del [loop de ReAct](agents-vs-workflows.es.md#patrón-de-agent-el-llm-controla-el-camino) que ya vimos en pseudocódigo — acá está con el formato real de mensajes yendo y viniendo.
...
---
Relacionado: [De ML clásico a Agentic AI](from-ml-to-agentic-ai.es.md#7-tool-use--function-calling--el-llm-puede-hacer-no-solo-hablar-2023), [Agentes vs Workflows](agents-vs-workflows.es.md), [MCP](mcp.es.md), [Diseño de Agentes](agent-design.es.md), [Costos de LLMs](llm-costs.es.md).
