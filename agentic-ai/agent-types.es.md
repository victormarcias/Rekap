...
El **LLM es el motor de razonamiento** — comprenden lenguaje natural complejo, generan planes sofisticados, y hacen razonamiento contextual avanzado sin reglas hardcodeadas para cada situación. Es el tipo de agente que ya desarrollamos en detalle en [Agentes vs Workflows](agents-vs-workflows.es.md) (el loop ReAct) y [n8n](../stacks/n8n/n8n-and-agentic-ai.es.md) (el nodo AI Agent).
