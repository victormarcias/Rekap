...
- **Workflow con un agent adentro**: la estructura general es un workflow (pasos predecibles, guardrails, validaciones), que en un paso puntual delega a un agent cuando ese paso específico necesita razonamiento abierto. Es literalmente lo que permite el nodo AI Agent de [n8n](../stacks/n8n/n8n-and-agentic-ai.es.md#el-nodo-ai-agent): el workflow sigue siendo la estructura fija de nodos conectados, pero uno de esos nodos internamente corre un loop agentic.
...
---
Relacionado: [De ML clásico a Agentic AI](from-ml-to-agentic-ai.es.md), [Function Calling](function-calling.es.md), [n8n](../stacks/n8n/n8n-and-agentic-ai.es.md).
