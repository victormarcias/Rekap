...
---
Relacionado: [Qué es un token](que-es-un-token.md), [De ML clásico a Agentic AI](historia-de-ml-a-agentic.md), [Agentes vs Workflows](agentes-vs-workflows.md), [Circuit Breaker](../system-design/quality-attributes.es.md#tolerancia-a-fallos), [VPS vs Cloud Run](../devops/vps-vs-cloud-run.es.md), [Riesgos y Mitigaciones](riesgos-y-mitigaciones.md), [Tamaño y Cuantización de Modelos](tamano-y-cuantizacion.md).
