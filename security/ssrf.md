...
---
Relacionado: [SQL Injection](sql-injection.md), [AWS — Servicios Principales](../cloud/aws/core-services.es.md) (metadata endpoint), [Dockerización](../devops/docker.es.md).
