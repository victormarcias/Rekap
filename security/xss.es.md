...
- **Content-Security-Policy**: restringe de qué orígenes puede cargar/ejecutar scripts la página — mitiga el impacto aunque el escape falle en algún lugar puntual (ver [Security Headers](security-headers.es.md#content-security-policy-csp)).
