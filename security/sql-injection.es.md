...
---
Relacionado: [Motores de SQL](../database/sql-engines.es.md), [Controller / Service / Repository](../backend/controller-service-repository.es.md#orm-object-relational-mapping), [SSRF](ssrf.es.md).
