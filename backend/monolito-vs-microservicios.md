...
**A favor**: simple de desarrollar, testear y deployar al principio; una transacción de DB que cruza "módulos" es una transacción normal (ver [ACID](../sql/acid-transacciones-isolation.md)); no hay latencia de red entre componentes internos.
