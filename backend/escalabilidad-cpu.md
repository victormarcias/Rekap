...
Cuando el cuello de botella es cómputo, no espera — la [causa y el diagnóstico](../diagnostics/backend.es.md#cpu-bound) ya están en `diagnostics/backend.es.md`. Acá el foco es la pregunta de escalabilidad: una vez identificado que el problema es CPU, ¿qué hacer?
