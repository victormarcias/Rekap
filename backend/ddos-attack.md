...
---
Relacionado: [CDN](../devops/cdn.md), [API Gateway](api-gateway.md), [Qué pasa cuando escribís una URL](../system-design/que-pasa-cuando-escribis-una-url.md) (TCP handshake), [Elasticidad](../system-design/atributos-de-calidad.md#elasticidad).
