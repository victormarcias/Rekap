...
Reparten el tráfico entrante entre varias instancias de un servicio — la pieza que hace posible la [escalabilidad horizontal](../system-design/quality-attributes.es.md#escalabilidad).
...
---
Relacionado: [Kubernetes](../devops/kubernetes.es.md), [Escalabilidad](../system-design/quality-attributes.es.md#escalabilidad), [Deploy a un VPS](../devops/deploy-vps.es.md) (Nginx como reverse proxy).
