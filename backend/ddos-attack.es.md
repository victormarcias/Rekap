...
---
Relacionado: [CDN](../devops/cdn.es.md), [API Gateway](api-gateway.es.md), [Qué pasa cuando escribís una URL](../system-design/que-pasa-cuando-escribis-una-url.md) (TCP handshake), [Elasticidad](../system-design/atributos-de-calidad.md#elasticidad), [Security](../security/README.es.md) (vulnerabilidades de aplicación, distinto de un ataque de tráfico).
