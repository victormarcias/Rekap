...
---
Relacionado: [Fundamentos de n8n](basico.md), [Cómo se testea](testing.md), [Agentes vs Workflows](../../agentic-ai/agentes-vs-workflows.md), [Tipos de Agentes de IA](../../agentic-ai/tipos-de-agentes.md), [De ML clásico a Agentic AI](../../agentic-ai/historia-de-ml-a-agentic.md).
