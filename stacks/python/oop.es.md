...
---
Relacionado: [Patrones creacionales](../../system-design/creational-patterns.es.md) (Singleton usa `__new__`), [Patrones estructurales](../../system-design/structural-patterns.es.md) (Class Adapter necesita herencia múltiple), [Tipos y Mutabilidad](types-and-mutability.es.md) (mutable default arguments, mismo mecanismo de fondo).
