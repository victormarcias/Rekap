...
---
Relacionado: [Arquitectura de NestJS](architecture.es.md), [Autenticación y Seguridad](../../backend/authentication.es.md), [Endpoints para microservicios (FastAPI)](../fastapi/microservice-endpoints.es.md#3-validación-de-entrada-con-pydantic) (Pydantic cumple el mismo rol que un DTO + Pipe, en Python).
