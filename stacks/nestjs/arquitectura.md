...
---
Relacionado: [Pipes, Guards, Interceptors y Exception Filters](pipes-guards-interceptors-filters.md), [Controller / Service / Repository](../../backend/controller-service-repository.es.md) (mismo patrón, agnóstico de framework), [Endpoints para microservicios (FastAPI)](../fastapi/endpoints-microservicios.md#4-dependency-injection-con-depends) (mismo concepto de DI, en Python).
