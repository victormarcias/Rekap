...
---
See [NoSQL](nosql.md) and [ORM (Object-Relational Mapping)](../backend/controller-service-repository.md#orm-object-relational-mapping) for the details of each. To separate runtime from framework from ORM from frontend (why "Node vs FastAPI" isn't an even comparison), see [Overview: layers of a stack](../stacks/stack-layers.md).
