...
---
Ver [NoSQL](nosql.md), [DynamoDB](dynamodb-key-value-store.md), [Redis](redis.md) y [ORM (Object-Relational Mapping)](../backend/controller-service-repository.md#orm-object-relational-mapping) para el detalle de cada uno.
