...
---
Ver [NoSQL](nosql.md), [DynamoDB](../backend/dynamodb-key-value-store.md), [Redis](../backend/redis.md) y [ORM (Object-Relational Mapping)](../backend/controller-service-repository.md#orm-object-relational-mapping) para el detalle de cada uno.
