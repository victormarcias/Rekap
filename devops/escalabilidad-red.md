...
- **CDN para tráfico saliente hacia usuarios**: sacar el tráfico de assets estáticos del origin server hacia el edge reduce directamente la carga de red que tiene que soportar tu infraestructura — ver [CDN](cdn.md).
