...
---
Relacionado: [Clustering](../diagnostics/backend.es.md#clustering), [Escalabilidad vertical vs horizontal](scaling-vertical-vs-horizontal.es.md), [Load balancers](../backend/load-balancers.md).
