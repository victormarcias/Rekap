...
Comparación entre [Deploy a un VPS](deploy-vps.es.md) (servidor propio, siempre prendido) y [Deploy a Cloud Run](deploy-cloud-run.es.md) (contenedor serverless, escala a cero).
...
---
Relacionado: [Deploy a un VPS](deploy-vps.es.md), [Deploy a Cloud Run](deploy-cloud-run.es.md), [Cold start](../diagnostics/devops.es.md), [Elasticidad](../system-design/quality-attributes.es.md#elasticidad).
