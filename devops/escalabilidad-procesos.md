...
Sumar más procesos/workers en paralelo — el escalón intermedio entre "un solo proceso" y "escalar a múltiples máquinas". Ya vimos el patrón dentro de una sola máquina como [Clustering](../diagnostico/backend.md#clustering); esto es la misma idea, llevada al nivel de infraestructura completa.
...
---
Relacionado: [Clustering](../diagnostico/backend.md#clustering), [Escalabilidad vertical vs horizontal](escalabilidad-vertical-horizontal.md), [Load balancers](../backend/load-balancers.md).
